...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : ven. 24 mars 2023 à 08:44
...
CREATE TABLE IF NOT EXISTS `stock` (
  `QTESTOCK` int(11) UNSIGNED DEFAULT NULL,
...
INSERT INTO `stock` (`QTESTOCK`, `MATRICULE`, `MED_DEPOTLEGAL`) VALUES
(53, 'a131', '3MYC7'),
(3, 'a131', 'ADIMOL9'),
(3, 'a131', 'AMOX45'),
(3, 'a131', 'CARTION6'),
...
INSERT INTO `visiteur` (`MATRICULE`, `NOM`, `PRENOM`, `LOGIN`, `MDP`, `ADRESSE`, `CODEPOSTAL`, `DATEENTREE`, `CODEUNIT`, `NOMUNIT`, `TELEPHONE`, `PRIME`) VALUES
('', 'test', 'test', 'test', 'teet', 'test', '13012', '2023-03-16 09:40:21', 'te', 'test', 'test', 0),
('4561', '', '', '', '', '', '13012', '2023-03-17 09:25:46', '', '', '', 0),
('a131', 'Villechalane', 'Louis', 'lvillachane', 'jux7g', '8 rue des Charmes', '46000', '2005-12-21 00:00:00', 'SW', 'SWISS', NULL, NULL),
('a134', 'test', 'test', 'test', 'test', 'test', '13012', '2023-03-11 09:42:33', 'test', 'test', 'test', 0),
('a145', 'test', 'test', 'test', 'test', 'test', '13012', '2023-03-11 09:42:33', 'rzrz', 'test', 'test', 0),
('a17', 'Andre', 'David', 'dandre', 'oppg5', '1 rue Petit', '46200', '1998-11-23 00:00:00', 'BO', 'BOURDIN', NULL, NULL),
('a55', 'Bedos', 'Christian', 'cbedos', 'gmhxd', '1 rue Peranud', '46250', '1995-01-12 00:00:00', 'BO', 'BOURDIN', NULL, NULL),
('a93', 'Tusseau', 'Louis', 'ltusseau', 'ktp3s', '22 rue des Ternes', '46123', '2000-05-01 00:00:00', 'SW', 'SWISS', NULL, NULL),
('b13', 'Bentot', 'Pascal', 'pbentot', 'doyw1', '11 allée des Cerises', '46512', '1992-07-09 00:00:00', 'BO', 'BOURDIN', NULL, NULL),
('b16', 'Bioret', 'Luc', 'lbioret', 'hrjfs', '1 Avenue gambetta', '46000', '1998-05-11 00:00:00', 'SW', 'SWISS', NULL, NULL),
('b19', 'Bunisset', 'Francis', 'fbunisset', '4vbnd', '10 rue des Perles', '93100', '1987-10-21 00:00:00', 'BO', 'BOURDIN', NULL, NULL),
('b25', 'Bunisset', 'Denise', 'dbunisset', 's1y1r', '23 rue Manin', '75019', '2010-12-05 00:00:00', 'SW', 'SWISS', NULL, NULL),
('b28', 'Cacheux', 'Bernard', 'bcacheux', 'uf7r3', '114 rue Blanche', '75017', '2009-11-12 00:00:00', 'SW', 'SWISS', NULL, NULL),
('b34', 'Cadic', 'Eric', 'ecadic', '6u8dc', '123 avenue de la République', '75011', '2008-09-23 00:00:00', 'BO', 'BOURDIN', NULL, NULL),
('b4', 'Charoze', 'Catherine', 'ccharoze', 'u817o', '100 rue Petit', '75019', '2005-11-12 00:00:00', 'SW', 'SWISS', NULL, NULL),
('b50', 'Clepkens', 'Christophe', 'cclepkens', 'bw1us', '12 allée des Anges', '93230', '2003-08-11 00:00:00', 'BO', 'BOURDIN', NULL, NULL),
('b59', 'Cottin', 'Vincenne', 'vcottin', '2hoh9', '36 rue Des Roches', '93100', '2001-11-18 00:00:00', 'SW', 'SWISS', NULL, NULL),
('c14', 'Daburon', 'François', 'fdaburon', '7oqpv', '13 rue de Chanzy', '94000', '2002-02-11 00:00:00', 'SW', 'SWISS', NULL, NULL),
('c3', 'De', 'Philippe', 'pde', 'gk9kx', '13 rue Barthes', '94000', '2010-12-14 00:00:00', 'BO', 'BOURDIN', NULL, NULL),
('c456', 'LaPaix', 'Lycee', 'lapaix56', '123456789', 'adresse', '44000', '2005-12-21 00:00:00', 'BO', 'SWISS', '0102030405', 10),
('c54', 'Debelle', 'Michel', 'mdebelle', 'od5rt', '181 avenue Barbusse', '93210', '2006-11-23 00:00:00', 'BO', 'BOURDIN', NULL, NULL),
('d123', 'Nom', 'Prenom', 'login', 'mdpdpdpdpeep', 'adresse', '13012', '2023-03-16 09:06:49', 'GW', 'TE', '011223546', 0),
('d13', 'Debelle', 'Jeanne', 'jdebelle', 'nvwqq', '134 allée des Joncs', '44000', '2000-05-11 00:00:00', 'SW', 'SWISS', NULL, NULL),
('d148', 'NomTest', 'test', 'dedede', 'dedede', 'ererere54er', '45000', '2023-12-01 08:12:01', 'GW', 'dede', '06060606', 0),
('d51', 'Debroise', 'Michel', 'mdebroise', 'sghkb', '2 Bld Jourdain', '44000', '2001-04-17 00:00:00', 'BO', 'BOURDIN', NULL, NULL),
('d88', 'LaPaix', 'Lycee', 'lapaix56', '123456789', 'adresse', '44000', '2005-12-21 00:00:00', 'BO', 'SWISS', '0102030405', 10),
('e22', 'Desmarquest', 'Nathalie', 'ndesmarquest', 'f1fob', '14 Place d Arc', '45000', '2005-11-12 00:00:00', 'SW', 'SWISS', NULL, NULL),
('e24', 'Desnost', 'Pierre', 'pdesnost', '4k2o5', '16 avenue des Cèdres', '23200', '2001-02-05 00:00:00', 'BO', 'BOURDIN', NULL, NULL),
('e39', 'Dudouit', 'Frédéric', 'fdudouit', '44im8', '18 rue de l église', '23120', '2000-08-01 00:00:00', 'SW', 'SWISS', NULL, NULL),
('e49', 'Duncombe', 'Claude', 'cduncombe', 'qf77j', '19 rue de la tour', '23100', '1987-10-10 00:00:00', 'SW', 'SWISS', NULL, NULL),
('e5', 'Enault-Pascreau', 'Céline', 'cenault', 'y2qdu', '25 place de la gare', '23200', '1995-09-01 00:00:00', 'BO', 'BOURDIN', NULL, NULL),
('e52', 'Eynde', 'Valérie', 'veynde', 'i7sn3', '3 Grand Place', '13015', '1999-11-01 00:00:00', 'BO', 'BOURDIN', NULL, NULL),
('e741', 'test', 'fefe', 'fefe', 'fefefefef', 'fefe', '13012', '2023-03-10 02:32:08', 'fef', 'fef', 'fefef', 0),
('f21', 'Finck', 'Jacques', 'jfinck', 'mpb3t', '10 avenue du Prado', '13012', '2001-11-10 00:00:00', 'SW', 'SWISS', NULL, NULL),
('f39', 'Frémont', 'Fernande', 'ffremont', 'xs5tq', '4 route de la mer', '13012', '1998-10-01 00:00:00', 'BO', 'BOURDIN', NULL, NULL),
('f4', 'Gest', 'Alain', 'agest', 'dywvt', '30 avenue de la mer', '13025', '1985-11-01 00:00:00', 'SW', 'SWISS', NULL, NULL),
('F456', 'test', 'test', 'test', 'testtest', 'tes', '44000', '1995-01-12 00:00:00', 'BO', 'GSb', '', 0),
('p13', 'LaPaix', 'Lycee', 'lapaix56', '123456789', 'adresse', '44000', '2005-12-21 00:00:00', 'BO', 'SWISS', '0102030405', 10),
('q788', 'dadzd', 'zdzdzdzdz', 'dzdzdz', 'uyguyg', 'zdzd', '93100', '2023-03-21 04:49:02', 'SW', 'dzdzd', '594984894', 0),
('q789', '', '', '', '', '', '93100', '2023-03-21 04:49:02', 'SW', '', '', 0),
('q99', 'LaPaix', 'Lycee', 'lapaix56', '123456789', 'adresse', '44000', '2005-12-21 00:00:00', 'BO', 'SWISS', '0102030405', 10),
('r789', 'test', 'test', 'test', 'test', 'test', '13012', '2023-03-23 01:33:30', 'SW', 'test', 'test', 0),
('tes8', 'test', 'test', 'test', 'test', 'test', '13025', '2023-01-03 09:01:43', 'tes', 'test', 'test', 0),
('tesk', 'test', 'test', 'test', 'test', 'test', '13012', '2023-01-03 09:01:43', 'tes', 'test', 'test', 0),
('test', 'test', 'test', 'test', 'test', 'test', '13012', '2005-12-21 00:00:00', 'BO', 'te', '', 0),
('z65', 'LaPaix', 'Lycee', 'lapaix56', '123456789', 'adresse', '44000', '2005-12-21 00:00:00', 'BO', 'SWISS', '0102030405', 10),
('z99', 'Nom', 'Prenom', 'test', 'test', 'laRue', '46000', '2005-12-21 00:00:00', 'SW', 'Zw', '', 0);
...
--
ALTER TABLE `stock`
  ADD CONSTRAINT `MATRICULE_VISI` FOREIGN KEY (`MATRICULE`) REFERENCES `visiteur` (`MATRICULE`),
  ADD CONSTRAINT `MEDI_DEPOTLegal` FOREIGN KEY (`MED_DEPOTLEGAL`) REFERENCES `medicament` (`MED_DEPOTLEGAL`);
